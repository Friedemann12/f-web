    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($slct_posts)) {
            ...
            if ($_SESSION["user_role"] === "admin") {
                ...
                echo "<td><a onclick=\"javascript: return confirm('Are you Sure you want to reset the view-count?');\" href='posts.php?source=reset-views&p_id=$post_id' disabled> Reset</a></td>";
            }
            echo "<td ><a href = 'posts.php?source=edit-post&p_id=$post_id' > Edit</a ></td > ";
            if ($_SESSION["user_role"] === "admin") {
                echo "<td ><a onclick=\"javascript: return confirm('Are you Sure you want to delete?');\" href = 'posts.php?delete=$post_id' > Delete</a ></td > ";
            } else {
                echo "<td ><a onclick=\"javascript: return confirm('Are you Sure you want to delete?');\" href = 'posts.php?delete=$post_id' disabled> Delete</a ></td > ";
            }
            echo "</tr > ";
        }
        ?>
