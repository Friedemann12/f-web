...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <textarea name="post_content" class="form-control" id="editor" cols="30"
    ...
    <div class="form-group"><input class="btn btn-primary" type="submit" name="edit-post" value="Edit Post"></div>
