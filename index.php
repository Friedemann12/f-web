...
<head>
    ...
    <meta name="description" content="Web Development Portfolio of Julian Friedemann">
    <meta name="author" content="Julian Friedemann">

    <title>Portfolio - Julian Friedemann</title>
...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img class="masthead-avatar mb-5" src="img/character.jpg" alt="">

            <!-- Masthead Heading -->
            <h1 class="masthead-heading text-uppercase mb-0">Hi,<br>I'm Julian Friedemann</h1>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <form name="email-form" id="contactForm" novalidate="novalidate" method="post" action="mail/contact_me.php">
                        ...
                        <div class="form-group">
                            <input type="submit" name="send-mail" class="btn btn-primary btn-xl" id="sendMessageButton" value="Send">
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <p class="lead mb-0">Hamburg, Germany</p>
                </div>
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <a class="btn btn-outline-light btn-social mx-1" href="https://www.xing.com/profile/Julian_Friedemann" target="_blank">
                        <i class="fab fa-fw fa-xing"></i>
                    </a>
                    <a class="btn btn-outline-light btn-social mx-1" href="https://linkedin.com/in/julian-friedemann" target="_blank">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <a href="https://portfolio.friedemann-web.de" target="_blank"><img class="img-fluid rounded mb-5" src="img/portfolio/b-i-a.png" alt=""></a>
                                <!-- Portfolio Modal - Text -->
                                <p class="mb-4">Click on the image for my Version<i class="arrow up"></i></p>
                                <p class="mb-5">An amazing Page by the Folks of <a href="https://www.buildinamsterdam.com/cases" target="_blank">Build in Amsterdam</a>,
                                    ...
                                    Javascript, Vue and CSS. All picture are free Stock-images from <a href="https://unsplash.com/">unplash</a>. Check-out the <a href="https://www.buildinamsterdam.com/cases" target="_blank">original</a>.
                                </p>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <a href="https://www.db-n.com/talent_posts/wir-begruessen-julian/" target="_blank"><img class="img-fluid rounded mb-5" src="img/portfolio/talentsblog.png" alt=""></a>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <!-- Portfolio Modal - Image -->
                                <a href="./portfolio/02-cms-blog-system" target="_blank"><img class="img-fluid rounded mb-5" src="img/portfolio/cms-blog-system.png" alt=""></a>
                                <!-- Portfolio Modal - Text -->
                                <p class="mb-4">Click on the image to see mine</p>
                                <p class="mb-5">A CMS and blog system created with php, a little javascript and bootstrap. For a test access to view the CMS, simply login with the username test and the password test. </p>
                                <button class="btn btn-primary" href="#" data-dismiss="modal">
                                    <i class="fas fa-times fa-fw"></i>
                                    Close Window
                                </button>
